...
- Submit an issue on our Issues page
  [here](https://github.com/earthlab/smapr/issues).
...
- **Clone** your version on your account down to your machine from your
  account, e.g,.
  `git clone https://github.com/<yourgithubusername>/smapr.git`.
- Make sure to **track upstream** progress (i.e., on our version of
  `smapr` at `earthlab/smapr`) by doing
  `git remote add upstream https://github.com/earthlab/smapr.git`.
...
- Make your **changes** (bonus points for making changes on a new
  branch).
- **Push** up to your account.
- Submit a **pull request** to home base at `earthlab/smapr`.

Please follow [this](http://adv-r.had.co.nz/Style.md) styleguide for
your contributions.
